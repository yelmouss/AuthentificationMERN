...
document.title = 'Home'
  ...
  return (
    <Font family='Ubuntu'>
      ...
      <Container className='mt-5 p-2 text-center  '>
        <h1> <Typed
        ...
        <Row className=''>
          <Col>
            <Atropos shadow={false}>
              <div className=" p-5 card bg-dark text-light bg-opacity-75">

                <h4>
                  <Typed
                    strings={[' I invite you to explore this innovative platform that leverages public APIs to provide you with a unique experience. Whether you\'re a tech enthusiast or just curious, this application will showcase my skills as a MERN developer in action.'
          ...
          <Col className='d-flex align-items-end justify-content-end text-end '>           
              <img src={Geek} alt="Logo" className='col-8 img-fluid bg-light rounded rounded-circle p-5 bg-opacity-75 ' />         
          </Col>
        </Row>
      </Container >
    </Font>
